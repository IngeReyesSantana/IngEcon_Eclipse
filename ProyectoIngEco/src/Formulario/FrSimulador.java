...
public class FrSimulador extends javax.swing.JFrame {
  ...
  public int ano = fecha.get(Calendar.YEAR);
  ...
  @SuppressWarnings("unchecked")
    ...
    TiposDeCredito = new javax.swing.ButtonGroup();
      ...
      lst_PeriodoDeAmortizacion = new javax.swing.JComboBox<>();
      ...
      CuadroDeAmortizacion = new javax.swing.JLabel();
      ...
      txt_Nombre.addActionListener(new java.awt.event.ActionListener() {
        ...
        PeriodoDeAmortizacion.setText("Periodo de Amortizacion:");
        getContentPane().add(PeriodoDeAmortizacion);
        PeriodoDeAmortizacion.setBounds(40, 330, 150, 20);

        lst_PeriodoDeAmortizacion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                lst_PeriodoDeAmortizacionActionPerformed(evt);
            }
        });
		getContentPane().add(lst_PeriodoDeAmortizacion);
		lst_PeriodoDeAmortizacion.setBounds(220, 330, 160, 30);
        ...
        CuadroDeAmortizacion.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        CuadroDeAmortizacion.setText("Cuadro de Amortizacion:");
        getContentPane().add(CuadroDeAmortizacion);
        CuadroDeAmortizacion.setBounds(570, 40, 180, 20);
    ...
    private void opt_CuotaFijaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_opt_CuotaFijaActionPerformed
        if (opt_CuotaFija.isSelected() == true) {
            ...
            lst_PeriodoDeAmortizacion.removeAllItems();
            ...
            for (Object p : periodo) {
                lst_PeriodoDeAmortizacion.addItem(p.toString());
            }
        }
    ...
    private void lst_PeriodoDeAmortizacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_lst_PeriodoDeAmortizacionActionPerformed
    }//GEN-LAST:event_lst_PeriodoDeAmortizacionActionPerformed
    ...
    private void btn_CalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_CalcularActionPerformed
        ...
        if (opt_CuotaFija.isSelected() == true && !lst_Plazo.getSelectedItem().equals("Seleccione") && !lst_PeriodoDeAmortizacion.getSelectedItem().equals("Seleccione") && txt_Periodico.getText().length() != 0 && txt_Monto.getText().length() != 0) {
        ...
        } else if (opt_PeriodoDeGracia.isSelected() == true && !lst_PeriodoGracia.getSelectedItem().equals("Seleccione") && !lst_Plazo.getSelectedItem().equals("Seleccione") && !lst_PeriodoDeAmortizacion.getSelectedItem().equals("Seleccione") && txt_Periodico.getText().length() != 0 && txt_Monto.getText().length() != 0) {
            tabla.addColumn("# cuotas");
            tabla.addColumn("Fechas");
            tabla.addColumn("Saldo capital");
            tabla.addColumn("Amort. capital");
    ...
    private void txt_EfectivoAnualKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_EfectivoAnualKeyReleased
        // TODO add your handling code here:
       if (opt_CuotaFija.isSelected() == true || opt_PeriodoDeGracia.isSelected() == true && !lst_PeriodoDeAmortizacion.getSelectedItem().equals("Seleccione")) {
    ...
    public void getDias() {
        if (lst_PeriodoDeAmortizacion.getSelectedItem().equals("Mensual")) {
            dias = 30;
            periodos = 12;
            pagos = 1;
        } else if (lst_PeriodoDeAmortizacion.getSelectedItem().equals("Bimestral")) {
            dias = 60;
            periodos = 6;
            pagos = 2;
        } else if (lst_PeriodoDeAmortizacion.getSelectedItem().equals("Trimestral")) {
            dias = 90;
            periodos = 4;
            pagos = 3;
        } else {
    ...
    private javax.swing.JLabel CuadroDeAmortizacion;
    ...
    private javax.swing.JComboBox<String> lst_PeriodoDeAmortizacion;
